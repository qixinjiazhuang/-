      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="/admin/vcompany/index" method="get">
                <div class="row"> 
                    <!-- select -->
                    <div class="col-md-2">
              ...
              <table id="example2" class="table table-bordered table-hover" style="table-layout:fixed;">
                ...
                <tr>
                  ...
                  <th style="text-align:center;">装修房型</th>
                  <th style="text-align:center;">服务保障</th>
                  <th style="text-align:center;">口碑</th>
                  <th style="text-align:center;">服务保障</th>
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="parent">
                    ...
                    <td style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["content"]); ?></td>
	                  <td style="text-overflow:ellipsis;text-align:center;">
	                  	  <a href="/admin/vcompany/edit?id=<?php echo ($v["id"]); ?>">编辑</a> | 
