      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="/admin/supervisor/update" method="post" enctype="multipart/form-data">
              <input type="hidden" name="id" value="<?php echo ($res["id"]); ?>">
              <div class="box-body">
      
                <div class="form-group">
                  <label for="exampleInputName">姓名</label>
                  <input style="width:50%;" id="did" type="text" name="name" required="required" class="form-control" value="<?php echo ($res["name"]); ?>" placeholder="请输入姓名">
                </div>
                <div class="form-group">
                  <label for="exampleInputName">联系方式</label>
                  <input style="width:50%;" type="text" name="phone" required="required" class="form-control" value="<?php echo ($res["phone"]); ?>" placeholder="请输入联系方式">
                </div>
                 <div class="form-group">
                 ...
                 <select class="form-control" style="width:10%;float:left;" id="s_province" name="province"></select>  
                  ...
                  <input style="width:50%;" type="text" name="introduce" required="required" class="form-control" value="<?php echo ($res["introduce"]); ?>" placeholder="请输入简介">
                </div>
                <div class="form-group">
                  ...
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="status">
                      <option value="1" <?php if($res['status'] == 1){ ?> selected="selected" <?php } ?> >已审核</option>
                      <option value="2" <?php if($res['status'] == 2){ ?> selected="selected" <?php } ?> >未审核</option>
                  </select>
                </div>
              </div>
