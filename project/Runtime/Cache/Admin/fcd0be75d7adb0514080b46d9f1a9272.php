      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="/admin/aboutus/index" method="get">
                <div class="row"> 
                    <!-- select -->
                    <div class="col-md-2">
                        <div class="form-group">
                            <a href="/admin/aboutus/add">添加</a>
                        </div>
                    </div>
              ...
              <table id="example2" class="table table-bordered table-hover" style="table-layout:fixed;">
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="parent">
                    ...
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?=date('Y-m-d H:i:s',$v['time'])?></td>
	                  <td class="name" style="text-overflow:ellipsis;text-align:center;"><a href="/admin/aboutus/edit?id=<?php echo ($v["id"]); ?>">修改</a> | <a href="/admin/aboutus/delete?id=<?php echo ($v["id"]); ?>">删除</a></td>
