      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="/admin/examine/index" method="get">
                <div class="row"> 
                    <!-- select -->
                    <div class="col-md-2">
              ...
              <table id="example2" class="table table-bordered table-hover" style="table-layout:fixed;">
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="parent">
                    ...
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["e_name"]); ?></td>
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><a id="example<?php echo ($v["uid"]); ?>" href="/Uploads/<?php echo ($v["e_photo"]); ?>"><img style="width:50xp;height:50px;" src="/Uploads/<?php echo ($v["e_photo"]); ?>" /></a></td>
                     <script>
                      $(function(){
	                  ...
	                  <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["number"]); ?></td>
                    <td style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["e_phone"]); ?></td>
                    ...
                    <td style="text-overflow:ellipsis;text-align:center;"><?= date('Y-m-d H:i:s',$v['ttime']) ?></td>
	                  ...
	                  <td style="text-overflow:ellipsis;text-align:center;">
	                  	  <a href="/admin/examine/edit?id=<?php echo ($v["uid"]); ?>">编辑</a> | <a href="/admin/examine/gogo?id=<?php echo ($v["uid"]); ?>">通过</a> |
	                      <a onClick="javascript:del()" href="/admin/examine/back?id=<?php echo ($v["uid"]); ?>">拒绝</a> 
                        <SCRIPT LANGUAGE=javascript>
                            function del() {
                            var msg = "您真的确定要拒绝？";
                                if (confirm(msg)==true){
                                        window.location.href="/admin/examine/back?id=<?php echo ($v["uid"]); ?>"
                                    }else{
