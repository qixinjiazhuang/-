      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="/admin/renovation/update" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input style="width:50%;" type="text" name="page" required="required" class="form-control" value="<?php echo ($res["page"]); ?>" id="exampleInputName" placeholder="请输入单价">
                </div>
                 <div class="form-group">
                  <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input style="width:50%;" type="text" required="required" name="introduction" value="<?php echo ($res["introduction"]); ?>" class="form-control" id="exampleInputPassword3" placeholder="请输入简介">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="ceramic">
                      <?php if(is_array($ceramic)): foreach($ceramic as $key=>$c): ?><option value="<?php echo ($c["name"]); ?>" <?php if($res['ceramic'] == $c['name']){ ?> selected="selected" <?php } ?> ><?php echo ($c["name"]); ?></option><?php endforeach; endif; ?>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="cupboard">
                      <?php if(is_array($cupboard)): foreach($cupboard as $key=>$a): ?><option value="<?php echo ($a["name"]); ?>" <?php if($res['cupboard'] == $a['name']){ ?> selected="selected" <?php } ?> ><?php echo ($a["name"]); ?></option><?php endforeach; endif; ?>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="door">
                      <?php if(is_array($door)): foreach($door as $key=>$d): ?><option value="<?php echo ($d["name"]); ?>" <?php if($res['door'] == $d['name']){ ?> selected="selected" <?php } ?> ><?php echo ($d["name"]); ?></option><?php endforeach; endif; ?>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="floor">
                    <?php if(is_array($floor)): foreach($floor as $key=>$f): ?><option value="<?php echo ($f["name"]); ?>" <?php if($res['floor'] == $f['name']){ ?> selected="selected" <?php } ?> ><?php echo ($f["name"]); ?></option><?php endforeach; endif; ?> 
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="bath">
                      <?php if(is_array($batn)): foreach($batn as $key=>$b): ?><option value="<?php echo ($b["name"]); ?>" <?php if($res['bath'] == $b['name']){ ?> selected="selected" <?php } ?> ><?php echo ($b["name"]); ?></option><?php endforeach; endif; ?>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="ceiling">
                      <?php if(is_array($ceiling)): foreach($ceiling as $key=>$g): ?><option value="<?php echo ($g["name"]); ?>" <?php if($res['ceiling'] == $g['name']){ ?> selected="selected" <?php } ?> ><?php echo ($g["name"]); ?></option><?php endforeach; endif; ?>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="switch">
                     <?php if(is_array($switch)): foreach($switch as $key=>$s): ?><option value="<?php echo ($s["name"]); ?>" <?php if($res['switch'] == $s['name']){ ?> selected="selected" <?php } ?> ><?php echo ($s["name"]); ?></option><?php endforeach; endif; ?>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="paint">
                      <?php if(is_array($paint)): foreach($paint as $key=>$p): ?><option value="<?php echo ($p["name"]); ?>" <?php if($res['paint'] == $p['name']){ ?> selected="selected" <?php } ?> ><?php echo ($p["name"]); ?></option><?php endforeach; endif; ?>
                  </select>
                </div>
                <br>
                <h4>设置展示图</h4><br>
