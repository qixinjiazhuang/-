      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="/admin/examine/staindex" method="get">
                <div class="row"> 
                    <!-- select -->
                    <div class="col-md-2">
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="parent">
                    ...
                    <td style="text-overflow:ellipsis;text-align:center;"><?= date('Y-m-d H:i:s',$v['ttime']) ?></td>
	                  ...
	                  <td style="text-overflow:ellipsis;text-align:center;">
	                  	  <a href="/admin/examine/gogo?id=<?php echo ($v["uid"]); ?>">通过</a> |
	                      <a onClick="javascript:del()" href="javascript:del()">拒绝</a> 
