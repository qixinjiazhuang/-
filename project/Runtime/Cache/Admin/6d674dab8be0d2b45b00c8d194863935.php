      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="/admin/material/update?id=<?php echo ($data["id"]); ?>" method="post" enctype="multipart/form-data">
        
              <div class="box-body">
                 
                <div class="form-group">
                  <label for="exampleInputPassword3">主材名</label>
                  <input style="width:50%;" type="text" required="required" name="name" value="<?php echo ($data["name"]); ?>" class="form-control" id="exampleInputPassword3" placeholder="请输入主材名">
                </div>
                <br/>
                  <label for="exampleInputPassword4">父主材</label>
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="pid">
                      <option value="0">根主材</option>
                      <?php if(is_array($alldata)): foreach($alldata as $key=>$v): ?><option
                      ...
                      disabled="disabled"
                      <?php } ?>
                       value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                  </select>
                </div>
              </div>
              <!-- /.box-body -->
