      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="/admin/foreman/appinsert" method="post" enctype="multipart/form-data">
        
              <div class="box-body">
                 <div class="form-group">
                  <label for="exampleInputPassword3">业主联系电话</label>
                  <input style="width:50%;" type="text" required="required" name="uphone" value="" class="form-control" id="did" placeholder="请输入工长">
                </div>
                
                <div class="form-group">
                  <label for="exampleInputPassword3">工长联系电话</label>
                  <input style="width:50%;" type="text" required="required" name="gphone" value="" class="form-control" id="did2" placeholder="请输入工长">
                </div>
                <div class="form-group">
