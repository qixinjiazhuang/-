      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="/admin/friendlink/insert" method="post" enctype="multipart/form-data">
        
              <div class="box-body">
      
                <div class="form-group">
                  <label for="exampleInputName">链接名称</label>
                  <input style="width:50%;" type="text" name="linkname" required="required" class="form-control" value="" placeholder="请输入标题">
                </div>
                 <div class="form-group">
                  <label for="exampleInputName">URL地址</label>
                  <input style="width:50%;" type="text" name="url" required="required" class="form-control" value="" placeholder="请输入标题">
                </div>
                <div class="form-group">
