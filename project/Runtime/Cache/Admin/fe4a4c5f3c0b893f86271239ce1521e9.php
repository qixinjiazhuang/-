  ...
  <div style="width:100%">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/admin/supervisor/index">监管管理</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="/admin/supervisor/index" method="get">
                <div class="row"> 
                    <!-- select -->
                    <div class="col-md-2">
                        <div class="form-group">
                            <a href="/admin/supervisor/add">添加</a>
                        </div>
                    </div>
              ...
              <table id="example2" class="table table-bordered table-hover" style="table-layout:fixed;">
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="parent">
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["name"]); ?></td>
	                  <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["city"]); ?></td>
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["phone"]); ?></td>
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["introduce"]); ?></td>
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?=$sta[$v['status']]?></td>
	                  <td class="name" style="text-overflow:ellipsis;text-align:center;"><a href="/admin/supervisor/edit?id=<?php echo ($v["id"]); ?>">修改</a> | <a href="/admin/supervisor/delete?id=<?php echo ($v["id"]); ?>">删除</a></td>
