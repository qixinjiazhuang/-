...
<!-- Content Wrapper. Contains page content -->
  <!-- <div class="content-wrapper"> -->
    ...
    <section class="content-header">
      <h1>
        装修案例管理
        <small>添加装修案例属性</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('/admin/index') }}"><i class="fa fa-dashboard"></i> 主页</a></li>
        <li><a href="#">装修案例</a></li>
        <li class="active">添加装修案例属性</li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="/admin/case/addcase" method="post" enctype="multipart/form-data">
              <input type="hidden" name="cid" value="<?php echo ($id); ?>">
                ...
                <div class="form-group">
                  ...
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="style">
                      ...
                      <option value="4">地中海</option>
                      <option value="5">东南亚</option>
                      <option value="5">新古典主义</option>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="page">
                      ...
                      <option value="6">100-200万</option>
