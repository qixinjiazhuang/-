      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="/admin/mechanic/insert" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="level">
                      <option value="1">普通技工</option>
                      <option value="2">高级技工</option>
                  </select>
                </div>
                <div class="form-group">
                ...
                <br/>
                  ...
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="type">
                      ...
                      <option value="2">泥瓦工</option>
                      <option value="3">油漆工</option>
