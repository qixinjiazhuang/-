      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="/admin/material/index" method="get">
                <div class="row"> 
                    <!-- select -->
                    <div class="col-md-2">
                        <div class="form-group">
                            <a href="/admin/material/add">添加</a>
                        </div>
                    </div>
              ...
              <table id="example2" class="table table-bordered table-hover" style="table-layout:fixed;">
                ...
                <tr>
                  ...
                  <th style="text-align: center;">主材名</th>
                ...
                <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="parent">
                    ...
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["name"]); ?></td>	
	                  <td style="text-overflow:ellipsis;text-align:center;">
	                  	  <a href="/admin/material/edit?id=<?php echo ($v["id"]); ?>">编辑</a> | 
	                      <a onClick="javascript:del()" href="/admin/material/delete?id=<?php echo ($v["id"]); ?>">删除</a> 
	                  </td>
