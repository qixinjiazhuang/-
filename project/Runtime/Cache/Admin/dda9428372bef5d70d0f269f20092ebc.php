      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="/admin/tender/index" method="get">
                <div class="row"> 
                    <!-- select -->
                    <div class="col-md-2">
                        <div class="form-group">
                            <a href="/admin/tender/add">添加</a>
                        </div>
                    </div>
              ...
              <table id="example2" class="table table-bordered table-hover" style="table-layout:fixed;">
                ...
                <tr>
                  ...
                  <th style="text-align:center;">装修方式</th>
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="parent">
                    ...
                    <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["phone"]); ?></td>
                    <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["address"]); ?></td>
                    <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["acreage"]); ?>㎡</td>
                    <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["cellname"]); ?></td>
                    <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?=$method[$v['method']]?></td>
	                  <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?=$type[$v['type']]?></td>
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["city"]); ?></td>
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?=$style[$v['style']]?></td>
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?=$budget[$v['budget']]?></td>
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><a id="example<?php echo ($v["id"]); ?>" href="/Uploads/<?php echo ($v["pic"]); ?>"><img style="width:50xp;height:50px;" src="/Uploads/<?php echo ($v["pic"]); ?>" /></a></td>
                     <script>
                      $(function(){
                     ...
                     <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?=$status[$v['status']]?></td>
                     <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?=$examine[$v['examine']]?></td>
	                  <td style="text-overflow:ellipsis;text-align:center;">
	                  	  <a href="/admin/tender/edit?id=<?php echo ($v["id"]); ?>">编辑</a> | 
