      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="/admin/foreman/index" method="get">
                <div class="row"> 
                    <!-- select -->
                    <div class="col-md-2">
              ...
              <table id="example2" class="table table-bordered table-hover" style="table-layout:fixed;">
                ...
                <tr>
                  ...
                  <th style="text-align:center;">工长级别</th>
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): if($v['delete']==1){ ?>
                    ...
                    <td style="text-overflow:ellipsis;text-align:center;"><?=$age[$v['age']]?></td>
	                  <td style="text-overflow:ellipsis;text-align:center;"><?=$sta[$v['status']]?></td>
	                  <td style="text-overflow:ellipsis;text-align:center;">
	                  	  <a href="/admin/foreman/edit?id=<?php echo ($v["uid"]); ?>">编辑</a> | 
	                      <a onClick="javascript:del()" href="/admin/foreman/delete?id=<?php echo ($v["uid"]); ?>">删除</a> 
                        <SCRIPT LANGUAGE=javascript>
                            function del() {
                            var msg = "您真的确定要删除？";
                                if (confirm(msg)==true){
                                        window.location.href="/admin/foreman/delete?id=<?php echo ($v["uid"]); ?>"
                                    }else{
