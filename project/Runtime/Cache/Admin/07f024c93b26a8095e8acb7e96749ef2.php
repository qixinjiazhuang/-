      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="/admin/images/index" method="get">
                <div class="row"> 
                    <!-- select -->
                    <div class="col-md-2">
                        <div class="form-group">
                            <a href="/admin/images/add">添加</a>
                        </div>
                    </div>
                    ...
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><a id="example<?php echo ($v["id"]); ?>" href="/Uploads/<?php echo ($v["logo"]); ?>"><img style="width:50xp;height:50px;" src="/Uploads/<?php echo ($v["logo"]); ?>" /></a></td>
                     <script>
                      ...
                      <td class="name" style="text-overflow:ellipsis;text-align:center;"><?=$sta[$v['status']]?></td>
  	                  <td class="name" style="text-overflow:ellipsis;text-align:center;"><a href="/admin/images/edit?id=<?php echo ($v["id"]); ?>">修改</a> | <a href="/admin/images/delete?id=<?php echo ($v["id"]); ?>">删除</a></td>
