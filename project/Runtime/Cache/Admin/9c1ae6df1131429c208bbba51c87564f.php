      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="/admin/business/index" method="get">
                <div class="row"> 
                    <!-- select -->
                    <div class="col-md-2">
                        <div class="form-group">
                           <a href="/admin/business/add">添加</a>
                        </div>
                    </div>
              ...
              <table id="example2" class="table table-bordered table-hover" style="table-layout:fixed;">
                ...
                <tr>
                  ...
                  <th style="text-align:center;">店铺标题</th>
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): if($v['delete']==1){ ?>
                    ...
                    <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["b_name"]); ?></td>
                    <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["title"]); ?></td>
                    <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["fax"]); ?></td>
                    <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["qq"]); ?></td>
                    <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["email"]); ?></td>
	                  <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["bushour"]); ?></td>
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["city"]); ?></td>
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["b_phone"]); ?></td>
	                  <td class="name" style="text-overflow:ellipsis;text-align:center;"><?=$type[$v['b_type']]?></td>
                    ...
                    <td style="text-overflow:ellipsis;text-align:center;"><?=$audit[$v['audit']]?></td>
	                  ...
	                  <td style="text-overflow:ellipsis;text-align:center;">
	                  	  <a href="/admin/business/edit?id=<?php echo ($v["uid"]); ?>">编辑</a> | 
	                      <a onClick="javascript:del()" href="/admin/business/delete?id=<?php echo ($v["uid"]); ?>">删除</a> 
	                  </td>
	                </tr>
