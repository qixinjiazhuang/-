      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="/admin/advert/index" method="get">
                <div class="row"> 
                    <!-- select -->
                    <div class="col-md-2">
                        <div class="form-group">
                            <a href="/admin/advert/add">添加</a>
                        </div>
                    </div>
              ...
              <table id="example2" class="table table-bordered table-hover" style="table-layout:fixed;">
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="parent">
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["id"]); ?></td>
	                  <td class="ids" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["linkname"]); ?></td>
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["url"]); ?></td>
                    ...
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["content"]); ?></td>
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?=$sta[$v['status']]?></td>
	                  <td class="name" style="text-overflow:ellipsis;text-align:center;"><a href="/admin/advert/edit?id=<?php echo ($v["id"]); ?>">修改</a> | <a href="/admin/advert/delete?id=<?php echo ($v["id"]); ?>">删除</a></td>
