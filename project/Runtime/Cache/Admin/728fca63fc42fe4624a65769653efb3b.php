      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="/admin/cate/update?id=<?php echo ($data["id"]); ?>" method="post" enctype="multipart/form-data">
        
              <div class="box-body">
                 
                <div class="form-group">
                  <label for="exampleInputPassword3">分类名</label>
                  <input style="width:50%;" type="text" required="required" name="name" value="<?php echo ($data["name"]); ?>" class="form-control" id="exampleInputPassword3" placeholder="请输入分类名">
                </div>
                <br/>
