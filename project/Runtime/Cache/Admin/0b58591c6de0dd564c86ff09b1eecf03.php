            ...
            <form role="form" action="/admin/designer/update" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input style="width:50%;" type="text" required="required" name="server" value="<?php echo ($res["server"]); ?>" class="form-control" id="exampleInputPassword3" placeholder="请输入服务理念">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword3">简介</label>
                  <input style="width:50%;" type="text" required="required" name="introduce" value="<?php echo ($res["introduce"]); ?>" class="form-control" id="exampleInputPassword3" placeholder="请输入简介">
                </div>
                <div class="form-group">
