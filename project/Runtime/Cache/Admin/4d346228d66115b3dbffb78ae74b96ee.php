  ...
  <div style="width:100%">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/admin/process/index">装修进程</a></li>
              ...
              <table id="example2" class="table table-bordered table-hover" style="table-layout:fixed;">
                ...
                <tr>
                  <th style="text-align:center;">ID</th>
                   <th style="text-align:center;">招标</th>
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="parent">
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["id"]); ?></td>
	                  <td class="ids" style="text-overflow:ellipsis;text-align:center;"><a href="/admin/process/tender?gid=<?php echo ($v["gid"]); ?>">查看招标</a></td>
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["starttime"]); ?></td>
