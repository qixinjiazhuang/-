      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="/admin/renovation/index" method="get">
                <div class="row"> 
                    <!-- select -->
                    <div class="col-md-2">
                        <div class="form-group">
                            <a href="/admin/renovation/add">添加</a>
                        </div>
                    </div>
              ...
              <table id="example2" class="table table-bordered table-hover" style="table-layout:fixed;">
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="parent">
                    ...
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["title"]); ?></td>
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["page"]); ?>元/㎡</td>
                    <td class="name" style="text-overflow:ellipsis;text-align:center;"><a id="example<?php echo ($v["id"]); ?>" href="/Uploads/<?php echo ($v["bpic"]); ?>"><img style="width:50xp;height:50px;" src="/Uploads/<?php echo ($v["bpic"]); ?>" /></a></td>
                     <script>
                      $(function(){
                    ...
                    <td style="text-overflow:ellipsis;text-align:center;"><?php echo ($v["num"]); ?></td>
	                  ...
	                  <td style="text-overflow:ellipsis;text-align:center;">
	                  	  <a href="/admin/renovation/edit?id=<?php echo ($v["id"]); ?>">编辑</a> | 
	                      <a onClick="javascript:del()" href="/admin/mechanic/delete?id=<?php echo ($v["id"]); ?>">删除</a> 
	                  </td>
