      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="/admin/foreman/insert" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="level">
                      <option value="1">普通工长</option>
                      <option value="2">优秀工长</option>
                  </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input style="width:50%;" type="text" required="required" name="idea" value="" class="form-control" id="exampleInputPassword3" placeholder="请输入内容">
                </div>
                <div class="form-group">
