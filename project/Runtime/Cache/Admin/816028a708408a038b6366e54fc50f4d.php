      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="/admin/company/insert" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input style="width:50%;" type="text" name="c_name" required="required" class="form-control" value="" id="exampleInputEmail1" placeholder="请输入公司名称">
                </div>
                 <div class="form-group">
                  <label for="exampleInputPassword3">公司简介</label>
                  <input style="width:50%;" type="text" required="required" name="introduce" value="" class="form-control" id="exampleInputPassword3" placeholder="请输入公司简介">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword3">联系人</label>
                  <input style="width:50%;" type="text" required="required" name="contacts" value="" class="form-control" id="exampleInputPassword3" placeholder="请输入联系人">
                </div>
                <div class="form-group">
