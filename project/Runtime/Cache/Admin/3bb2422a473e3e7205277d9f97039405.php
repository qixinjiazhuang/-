      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="/admin/friendlink/update?id=<?php echo ($res["id"]); ?>" method="post" enctype="multipart/form-data">
        
              <div class="box-body">
      
                <div class="form-group">
                  <label for="exampleInputName">链接名称</label>
                  <input style="width:50%;" type="text" name="linkname" required="required" class="form-control" value="<?php echo ($res["linkname"]); ?>" placeholder="请输入标题">
                </div>
                 <div class="form-group">
                  <label for="exampleInputName">URL地址</label>
                  <input style="width:50%;" type="text" name="url" required="required" class="form-control" value="<?php echo ($res["url"]); ?>" placeholder="请输入标题">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword3">描述</label><br/>
                ...
                <div class="form-group">
                  ...
                  <select style="width:50%;" class="form-control" required="required" id="exampleInputPassword4" name="status">
                      <option value="1" <?php if($res['status'] == 1){ ?> selected="selected" <?php } ?> >显示</option>
                      <option value="2" <?php if($res['status'] == 2){ ?> selected="selected" <?php } ?> >隐藏</option>
                  </select>
                </div>
                <div class="form-group">
