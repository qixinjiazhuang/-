      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="/admin/member/insert" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label for="exampleInputPassword4">类型</label>
                ...
                <div class="form-group">
                  ...
                  <select style="width:9%;float:left;" required="required" name="year" class="form-control" id="selYear"></select>&nbsp; &nbsp;
                  <select style="width:9%;float:left;" required="required" name="month" class="form-control" id="selMonth"></select>&nbsp; &nbsp;
                  <select style="width:9%;float:left;" required="required" name="day" class="form-control" id="selDay"></select>&nbsp; &nbsp;
                      <script type="text/javascript"> 
