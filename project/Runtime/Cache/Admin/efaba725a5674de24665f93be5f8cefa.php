      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="/admin/company/index" method="get">
                <div class="row"> 
                    <!-- select -->
                    <div class="col-md-2">
                        <div class="form-group">
                            <a href="/admin/company/add">添加</a>
                        </div>
                    </div>
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): if($v['delete']==1){ ?>
                    ...
                    <td style="text-overflow:ellipsis;text-align:center;"><?=$audit[$v['audit']]?></td>
	                  ...
	                  <td style="text-overflow:ellipsis;text-align:center;">
	                  	  <a href="/admin/company/vcompany?id=<?php echo ($v["uid"]); ?>">添加属性</a> | <a href="/admin/company/e_vcompany?id=<?php echo ($v["uid"]); ?>">修改属性</a> |<a href="/admin/company/edit?id=<?php echo ($v["uid"]); ?>">编辑</a> | 
	                      <a onClick="javascript:del()" href="/admin/company/delete?id=<?php echo ($v["uid"]); ?>">删除</a> 
